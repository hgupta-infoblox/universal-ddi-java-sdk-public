...
/**
 * A __FingerprintRule__ object (_dhcp/fingerprint_rule_) represents a DHCP fingerprint rule. A lease matches a fingerprint rule if all of the sub-rules evaluate to true. If a sub-rule doesn’t include a value (it has been left empty) it evaluates to true.
 */
...
public class LeasesFingerprintRule {
  ...
  public LeasesFingerprintRule() {
  }

  public LeasesFingerprintRule prefix(@javax.annotation.Nullable String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public LeasesFingerprintRule prl(@javax.annotation.Nullable List<String> prl) {
    this.prl = prl;
    return this;
  }

  public LeasesFingerprintRule addPrlItem(String prlItem) {
    if (this.prl == null) {
  ...
  public LeasesFingerprintRule vendor(@javax.annotation.Nullable String vendor) {
    this.vendor = vendor;
    return this;
  }
  ...
  public LeasesFingerprintRule vendorCompare(@javax.annotation.Nullable String vendorCompare) {
  ...
  public boolean equals(Object o) {
    ...
    LeasesFingerprintRule leasesFingerprintRule = (LeasesFingerprintRule) o;
    return Objects.equals(this.prefix, leasesFingerprintRule.prefix) &&
        Objects.equals(this.prl, leasesFingerprintRule.prl) &&
        Objects.equals(this.vendor, leasesFingerprintRule.vendor) &&
        Objects.equals(this.vendorCompare, leasesFingerprintRule.vendorCompare);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeasesFingerprintRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LeasesFingerprintRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LeasesFingerprintRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeasesFingerprintRule is not found in the empty JSON string", LeasesFingerprintRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LeasesFingerprintRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LeasesFingerprintRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeasesFingerprintRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeasesFingerprintRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeasesFingerprintRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeasesFingerprintRule.class));

       return (TypeAdapter<T>) new TypeAdapter<LeasesFingerprintRule>() {
           @Override
           public void write(JsonWriter out, LeasesFingerprintRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LeasesFingerprintRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LeasesFingerprintRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LeasesFingerprintRule
   * @throws IOException if the JSON string is invalid with respect to LeasesFingerprintRule
   */
  public static LeasesFingerprintRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeasesFingerprintRule.class);
  }

  /**
   * Convert an instance of LeasesFingerprintRule to an JSON string
   *
   * @return JSON string
   */
