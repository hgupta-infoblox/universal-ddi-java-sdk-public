...
public class IpamsvcDHCPInheritance {
  ...
  public IpamsvcDHCPInheritance() {
  }

  public IpamsvcDHCPInheritance asmConfig(@javax.annotation.Nullable IpamsvcInheritedASMConfig asmConfig) {
  ...
  public IpamsvcDHCPInheritance ddnsClientUpdate(@javax.annotation.Nullable InheritanceInheritedString ddnsClientUpdate) {
  ...
  public IpamsvcDHCPInheritance ddnsConflictResolutionMode(@javax.annotation.Nullable InheritanceInheritedString ddnsConflictResolutionMode) {
  ...
  public IpamsvcDHCPInheritance ddnsEnabled(@javax.annotation.Nullable InheritanceInheritedBool ddnsEnabled) {
  ...
  public IpamsvcDHCPInheritance ddnsHostnameBlock(@javax.annotation.Nullable IpamsvcInheritedDDNSHostnameBlock ddnsHostnameBlock) {
  ...
  public IpamsvcDHCPInheritance ddnsTtlPercent(@javax.annotation.Nullable InheritanceInheritedFloat ddnsTtlPercent) {
  ...
  public IpamsvcDHCPInheritance ddnsUpdateBlock(@javax.annotation.Nullable IpamsvcInheritedDDNSUpdateBlock ddnsUpdateBlock) {
  ...
  public IpamsvcDHCPInheritance ddnsUpdateOnRenew(@javax.annotation.Nullable InheritanceInheritedBool ddnsUpdateOnRenew) {
  ...
  public IpamsvcDHCPInheritance ddnsUseConflictResolution(@javax.annotation.Nullable InheritanceInheritedBool ddnsUseConflictResolution) {
  ...
  public IpamsvcDHCPInheritance dhcpConfig(@javax.annotation.Nullable IpamsvcInheritedDHCPConfig dhcpConfig) {
  ...
  public IpamsvcDHCPInheritance dhcpOptions(@javax.annotation.Nullable IpamsvcInheritedDHCPOptionList dhcpOptions) {
  ...
  public IpamsvcDHCPInheritance headerOptionFilename(@javax.annotation.Nullable InheritanceInheritedString headerOptionFilename) {
  ...
  public IpamsvcDHCPInheritance headerOptionServerAddress(@javax.annotation.Nullable InheritanceInheritedString headerOptionServerAddress) {
  ...
  public IpamsvcDHCPInheritance headerOptionServerName(@javax.annotation.Nullable InheritanceInheritedString headerOptionServerName) {
  ...
  public IpamsvcDHCPInheritance hostnameRewriteBlock(@javax.annotation.Nullable IpamsvcInheritedHostnameRewriteBlock hostnameRewriteBlock) {
  ...
  public boolean equals(Object o) {
    ...
    IpamsvcDHCPInheritance ipamsvcDHCPInheritance = (IpamsvcDHCPInheritance) o;
    return Objects.equals(this.asmConfig, ipamsvcDHCPInheritance.asmConfig) &&
        Objects.equals(this.ddnsClientUpdate, ipamsvcDHCPInheritance.ddnsClientUpdate) &&
        Objects.equals(this.ddnsConflictResolutionMode, ipamsvcDHCPInheritance.ddnsConflictResolutionMode) &&
        Objects.equals(this.ddnsEnabled, ipamsvcDHCPInheritance.ddnsEnabled) &&
        Objects.equals(this.ddnsHostnameBlock, ipamsvcDHCPInheritance.ddnsHostnameBlock) &&
        Objects.equals(this.ddnsTtlPercent, ipamsvcDHCPInheritance.ddnsTtlPercent) &&
        Objects.equals(this.ddnsUpdateBlock, ipamsvcDHCPInheritance.ddnsUpdateBlock) &&
        Objects.equals(this.ddnsUpdateOnRenew, ipamsvcDHCPInheritance.ddnsUpdateOnRenew) &&
        Objects.equals(this.ddnsUseConflictResolution, ipamsvcDHCPInheritance.ddnsUseConflictResolution) &&
        Objects.equals(this.dhcpConfig, ipamsvcDHCPInheritance.dhcpConfig) &&
        Objects.equals(this.dhcpOptions, ipamsvcDHCPInheritance.dhcpOptions) &&
        Objects.equals(this.headerOptionFilename, ipamsvcDHCPInheritance.headerOptionFilename) &&
        Objects.equals(this.headerOptionServerAddress, ipamsvcDHCPInheritance.headerOptionServerAddress) &&
        Objects.equals(this.headerOptionServerName, ipamsvcDHCPInheritance.headerOptionServerName) &&
        Objects.equals(this.hostnameRewriteBlock, ipamsvcDHCPInheritance.hostnameRewriteBlock);
  }

  @Override
  public int hashCode() {
    return Objects.hash(asmConfig, ddnsClientUpdate, ddnsConflictResolutionMode, ddnsEnabled, ddnsHostnameBlock, ddnsTtlPercent, ddnsUpdateBlock, ddnsUpdateOnRenew, ddnsUseConflictResolution, dhcpConfig, dhcpOptions, headerOptionFilename, headerOptionServerAddress, headerOptionServerName, hostnameRewriteBlock);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IpamsvcDHCPInheritance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IpamsvcDHCPInheritance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IpamsvcDHCPInheritance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IpamsvcDHCPInheritance is not found in the empty JSON string", IpamsvcDHCPInheritance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IpamsvcDHCPInheritance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IpamsvcDHCPInheritance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IpamsvcDHCPInheritance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IpamsvcDHCPInheritance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IpamsvcDHCPInheritance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IpamsvcDHCPInheritance.class));

       return (TypeAdapter<T>) new TypeAdapter<IpamsvcDHCPInheritance>() {
           @Override
           public void write(JsonWriter out, IpamsvcDHCPInheritance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IpamsvcDHCPInheritance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IpamsvcDHCPInheritance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IpamsvcDHCPInheritance
   * @throws IOException if the JSON string is invalid with respect to IpamsvcDHCPInheritance
   */
  public static IpamsvcDHCPInheritance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IpamsvcDHCPInheritance.class);
  }

  /**
   * Convert an instance of IpamsvcDHCPInheritance to an JSON string
   *
   * @return JSON string
   */
