...
/**
 * An __IPv6Address__ object (_ipv6address_) represents any single IPv6 address within a given network view.
 */
...
public class V3IPv6Address {
  ...
  public V3IPv6Address comment(@javax.annotation.Nullable String comment) {
  ...
  public V3IPv6Address ipAddress(@javax.annotation.Nonnull String ipAddress) {
    this.ipAddress = ipAddress;
    return this;
  }

  /**
   * The IPv6 Address of the address.
   * @return ipAddress
   */
  @javax.annotation.Nonnull
  ...
  public V3IPv6Address names(@javax.annotation.Nullable List<String> names) {
    this.names = names;
    return this;
  }

  public V3IPv6Address addNamesItem(String namesItem) {
    if (this.names == null) {
  ...
  /**
   * The DNS names. For example, if the IP address belongs to a host record, this field contains the hostname.
   * @return names
   */
  @javax.annotation.Nullable
  ...
  /**
   * The network to which this address belongs, in IPv6 Address/CIDR format.
   * @return network
   */
  @javax.annotation.Nullable
  ...
  public V3IPv6Address networkView(@javax.annotation.Nonnull String networkView) {
  ...
  public V3IPv6Address ref(@javax.annotation.Nullable String ref) {
    this.ref = ref;
    return this;
  }
  ...
  public V3IPv6Address tags(@javax.annotation.Nullable Object tags) {
    this.tags = tags;
    return this;
  }
  ...
  /**
   * The usage is a combination of indicators, each tracking a specific associated use. Listed below are usage indicators with their meaning:  usage indicator        | description  ---------------------- | --------------------------------  _IPAM_                 |  Address was created by the IPAM component.  _IPAM_, _RESERVED_     |  Address was created by the API call _wapi/v3/ipv6address_.  _IPAM_, _NETWORK_      |  Address was automatically created by the IPAM component and is the network address of the parent network.  _IPAM_, _BROADCAST_    |  Address was automatically created by the IPAM component and is the broadcast address of the parent network.  _DHCP_                 |  Address was created by the DHCP component.  _DHCP_, _FIXEDADDRESS_ |  Address was created by the API call _wapi/v3/ipv6fixedaddress_.  _DHCP_, _LEASED_       |  An active lease for that address was issued by a DHCP server.  _DHCP_, _DISABLED_     |  Address is disabled.  _DNS_                  |  Address is used by one or more DNS records.  _DISCOVERED_           |  Address is discovered by some network discovery probe like Network Insight or NetMRI in NIOS.
   * @return usage
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    V3IPv6Address v3IPv6Address = (V3IPv6Address) o;
    return Objects.equals(this.comment, v3IPv6Address.comment) &&
        Objects.equals(this.duid, v3IPv6Address.duid) &&
        Objects.equals(this.fingerprint, v3IPv6Address.fingerprint) &&
        Objects.equals(this.ipAddress, v3IPv6Address.ipAddress) &&
        Objects.equals(this.leaseState, v3IPv6Address.leaseState) &&
        Objects.equals(this.names, v3IPv6Address.names) &&
        Objects.equals(this.network, v3IPv6Address.network) &&
        Objects.equals(this.networkView, v3IPv6Address.networkView) &&
        Objects.equals(this.ref, v3IPv6Address.ref) &&
        Objects.equals(this.status, v3IPv6Address.status) &&
        Objects.equals(this.tags, v3IPv6Address.tags) &&
        Objects.equals(this.usage, v3IPv6Address.usage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, duid, fingerprint, ipAddress, leaseState, names, network, networkView, ref, status, tags, usage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V3IPv6Address {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V3IPv6Address
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V3IPv6Address.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V3IPv6Address is not found in the empty JSON string", V3IPv6Address.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V3IPv6Address.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V3IPv6Address` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V3IPv6Address.openapiRequiredFields) {
      ...
      if ((jsonObj.get("duid") != null && !jsonObj.get("duid").isJsonNull()) && !jsonObj.get("duid").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V3IPv6Address.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V3IPv6Address' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V3IPv6Address> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V3IPv6Address.class));

       return (TypeAdapter<T>) new TypeAdapter<V3IPv6Address>() {
           @Override
           public void write(JsonWriter out, V3IPv6Address value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V3IPv6Address read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V3IPv6Address given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V3IPv6Address
   * @throws IOException if the JSON string is invalid with respect to V3IPv6Address
   */
  public static V3IPv6Address fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V3IPv6Address.class);
  }

  /**
   * Convert an instance of V3IPv6Address to an JSON string
   *
   * @return JSON string
   */
