...
/**
 * A __NetworkContainer__ object (_networkcontainer_) encapsulates an IPv4 network container object. A network can contain child networks. The network that contains child networks is called a network container.
 */
...
public class V3NetworkContainer {
  ...
  public V3NetworkContainer comment(@javax.annotation.Nullable String comment) {
  ...
  public V3NetworkContainer federatedRealms(@javax.annotation.Nullable List<V3FederatedRealm> federatedRealms) {
    this.federatedRealms = federatedRealms;
    return this;
  }

  public V3NetworkContainer addFederatedRealmsItem(V3FederatedRealm federatedRealmsItem) {
  ...
  public V3NetworkContainer network(@javax.annotation.Nonnull String network) {
  ...
  public V3NetworkContainer networkView(@javax.annotation.Nonnull String networkView) {
  ...
  public V3NetworkContainer ref(@javax.annotation.Nullable String ref) {
    this.ref = ref;
    return this;
  }
  ...
  public V3NetworkContainer tags(@javax.annotation.Nullable Object tags) {
    this.tags = tags;
    return this;
  }

  /**
   * The tags for the network container in JSON format.
   * @return tags
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    V3NetworkContainer v3NetworkContainer = (V3NetworkContainer) o;
    return Objects.equals(this.comment, v3NetworkContainer.comment) &&
        Objects.equals(this.federatedRealms, v3NetworkContainer.federatedRealms) &&
        Objects.equals(this.network, v3NetworkContainer.network) &&
        Objects.equals(this.networkContainer, v3NetworkContainer.networkContainer) &&
        Objects.equals(this.networkView, v3NetworkContainer.networkView) &&
        Objects.equals(this.ref, v3NetworkContainer.ref) &&
        Objects.equals(this.tags, v3NetworkContainer.tags) &&
        Objects.equals(this.utilization, v3NetworkContainer.utilization);
  }
  ...
  public String toString() {
    ...
    sb.append("class V3NetworkContainer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V3NetworkContainer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V3NetworkContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V3NetworkContainer is not found in the empty JSON string", V3NetworkContainer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V3NetworkContainer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V3NetworkContainer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V3NetworkContainer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V3NetworkContainer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V3NetworkContainer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V3NetworkContainer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V3NetworkContainer.class));

       return (TypeAdapter<T>) new TypeAdapter<V3NetworkContainer>() {
           @Override
           public void write(JsonWriter out, V3NetworkContainer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V3NetworkContainer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V3NetworkContainer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V3NetworkContainer
   * @throws IOException if the JSON string is invalid with respect to V3NetworkContainer
   */
  public static V3NetworkContainer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V3NetworkContainer.class);
  }

  /**
   * Convert an instance of V3NetworkContainer to an JSON string
   *
   * @return JSON string
   */
